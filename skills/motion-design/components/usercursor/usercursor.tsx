...
export default function UserCursor(props: Props) {
    ...
    const hostStyle: React.CSSProperties = {
        position: "relative",
        // Fill the frame so the cursor area spans the whole preview instead of a
        // clipped 200×200 box. In Framer the injected `style` (below) carries the
        // frame's fixed size and overrides these; outside Framer they make it fill
        // the preview stage.
        width: "100%",
        height: "100%",
        overflow: "hidden",
